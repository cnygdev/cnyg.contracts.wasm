...
class cnyg_token_tester : public tester {
public:
...
BOOST_AUTO_TEST_SUITE(cnyg_token_tests)

BOOST_FIXTURE_TEST_CASE( create_tests, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( create_negative_max_supply, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( symbol_already_exists, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( create_max_supply, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( create_max_decimals, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( issue_tests, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( retire_tests, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( transfer_tests, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( open_tests, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( close_tests, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( transfer_fee_tests, cnyg_token_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( deposit, cnyg_token_tester ) try {
